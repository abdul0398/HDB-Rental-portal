        ...
        <section className="mx-auto px-2 py-3 w-full">
            ...
            <div className="w-full flex justify-center">
                <div className=" relative lg:w-1/2 md:w-1/2 w-full flex py-2 px-5">
                    <div className="mx-2 bg-white shadow-lg py-4 rounded-lg transition h-36 ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 duration-300 w-1/3 border border-b-0 border-l-0">
                        <p className="text-center lg:text-l md:text-l overflow-hidden">Total Transacactions</p>
                        <div className=" mt-5 flex items-center justify-center">
                            <p className="text-center lg:text-3xl md:text-3xl text-xl font-extrabold text-[#303dd7]">{transactions.length}</p>
                        </div>
                    </div>
                    <div className="mx-2 bg-white shadow-lg py-4 rounded-lg transition h-36 ease-in-out delay-150  hover:-translate-y-1 border hover:scale-110 duration-300 w-1/3">
                    ...
                    <div className="mx-2 bg-white shadow-lg py-4 rounded-lg transition h-36 ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 duration-300 w-1/3 border border-b-0 border-l-0 flex flex-col">
